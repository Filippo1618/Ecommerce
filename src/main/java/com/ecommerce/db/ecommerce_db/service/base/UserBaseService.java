...
import com.ecommerce.db.ecommerce_db.service.SecurityService;
...
public class UserBaseService {
	...
	public List<User> findByUserProd(String idUserProd) {
		return datastore.createQuery(User.class).field("userProd").equal(new ObjectId(idUserProd)).asList();
	}
